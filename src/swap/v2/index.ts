/**
 * TODO: Implement real v2 functions.
 * This is just a copy of v1_1 for now
 */
...
import {SwapExecution, SwapQuote, SwapType} from "../types";
 ...
 */
async function executedFixedInputSwap({
  client,
  pool,
  signedTxns,
  assetIn,
...
async function execute({
  ...
  try {
    ...
    if (swapType === SwapType.FixedInput) {
      swapData = await executedFixedInputSwap({
        client,
        pool,
        signedTxns,
        assetIn,
