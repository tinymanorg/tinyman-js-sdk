...
async function execute({
  ...
  try {
    const asset1Out =
      txGroup[V1_1RemoveLiquidityTxnIndices.ASSET1_OUT_TXN].txn.payment?.amount ??
      txGroup[V1_1RemoveLiquidityTxnIndices.ASSET1_OUT_TXN].txn.assetTransfer?.amount ??
      0n;
    const asset2Out =
      txGroup[V1_1RemoveLiquidityTxnIndices.ASSET2_OUT_TXN].txn.payment?.amount ??
      txGroup[V1_1RemoveLiquidityTxnIndices.ASSET2_OUT_TXN].txn.assetTransfer?.amount ??
      0n;
    const poolTokenIn =
      txGroup[V1_1RemoveLiquidityTxnIndices.POOL_TOKEN_IN_TXN].txn.assetTransfer
        ?.amount ?? 0n;
