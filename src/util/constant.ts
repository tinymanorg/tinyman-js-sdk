...
export const BASE_MINIMUM_BALANCE = 100_000n;
export const MINIMUM_BALANCE_REQUIRED_PER_ASSET = 100_000n;
export const MINIMUM_BALANCE_REQUIRED_PER_APP = 100_000n;
export const MINIMUM_BALANCE_REQUIRED_PER_CREATED_APP = 100_000n;
export const MINIMUM_BALANCE_REQUIRED_PER_EXTRA_APP_PAGE = 100_000n;
export const MINIMUM_BALANCE_REQUIRED_PER_BYTE_SCHEMA = 50_000n;
export const MINIMUM_BALANCE_REQUIRED_PER_INT_SCHEMA_VALUE = 28_500n;
