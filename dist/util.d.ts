...
import { AccountInformationData, TinymanAnalyticsApiAsset, InitiatorSigner } from "./common-types";
export declare function decodeState(stateArray?: AccountInformationData["apps-local-state"][0]["key-value"]): Record<string, number | string>;
...
export declare function optIntoAsset({ client, assetID, initiatorAddr, initiatorSigner }: {
    client: Algodv2;
    assetID: number;
 ...
 */
export declare function getAssetInformationById(algodClient: algosdk.Algodv2, id: number, alwaysFetch?: boolean): Promise<TinymanAnalyticsApiAsset>;
