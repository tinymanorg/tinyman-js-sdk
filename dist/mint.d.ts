 ...
 */
export declare function getMintLiquidityQuote({ pool, reserves, asset1In, asset2In }: {
    pool: PoolInfo;
...
export declare function generateMintTxns({ client, pool, asset1In, asset2In, liquidityOut, slippage, initiatorAddr }: {
    client: any;
    pool: PoolInfo;
    asset1In: number | bigint;
    asset2In: number | bigint;
...
export declare function signMintTxns({ pool, txGroup, initiatorSigner }: {
    pool: PoolInfo;
 ...
 *   account.
 */
export declare function mintLiquidity({ client, pool, txGroup, signedTxns, initiatorAddr }: {
    client: any;
    pool: PoolInfo;
    txGroup: SignerTransaction[];
