...
export declare function signSwapTransactions({ pool, txGroup, initiatorSigner }: {
    pool: PoolInfo;
 ...
 */
export declare function getSwapQuote(type: SwapType, pool: PoolInfo, reserves: PoolReserves, asset: {
    assetID: number;
    amount: number | bigint;
}, decimals: {
    assetIn: number;
 ...
 */
export declare function issueSwap({ client, pool, swapType, txGroup, signedTxns, initiatorAddr }: {
    client: Algodv2;
    pool: PoolInfo;
    swapType: SwapType;
    txGroup: SignerTransaction[];
