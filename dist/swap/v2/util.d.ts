 ...
 */
export declare function getV2SwapTotalFee(mode: SwapType, minFee: bigint): bigint;
/**
...
export declare function getSwapAppCallFeeAmount(swapType: SwapType, minFee: bigint): bigint;
